...
if (isset($_GET['id']) && $_GET['id'] != "") {
    ...
    $prod_fetch = $prod->fetch_prod($id, $db->conn);
    echo "<pre>";
    print_r($prod_fetch);
    echo "</pre>";
              ...
              <div class="card">
                ...
                <form method="post">
                    ...
                    <div class="p-4 bg-secondary">
                        ...
                        name="prod_name" placeholder="Product Name" value="<?php echo $val['prod_name']; ?>">
                ...
                <div class="p-4 bg-secondary">
                    ...
                    placeholder="ex:23" value="<?php echo $val['mon_price']; ?>" required>
                ...
                <div class="p-4 bg-secondary">
                    ...
                    class="form-control" min="0" maxlength=15 
                    placeholder="ex:23" value="<?php echo $val['annual_price']; ?>" required>
                ...
                <div class="p-4 bg-secondary">
                    ...
                    min="0" maxlength=15 value="<?php echo $val['sku']; ?>" required>
                    <div id="skuError"></div>
                </div>
                <hr class="line">
                <div class="card-header border-0">
