      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="#orders" data-toggle="collapse" 
            ...
            <li class="nav-item">
              <a class="nav-link active" href="#users" data-toggle="collapse" 
              role="button" aria-expanded="true" aria-controls="navbar-dashboards">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="#blog" data-toggle="collapse" 
              role="button" aria-expanded="true" aria-controls="navbar-dashboards">
          ...
          <ul class="navbar-nav align-items-center  ml-md-auto ">
            ...
            <li class="nav-item dropdown">
              ...
              dropdown-menu-right  py-0 overflow-hidden">
                ...
                text-primary font-weight-bold py-3">
                  View all
                </a>
              </div>
            </li>
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="http://localhost/Ced_Hosting/admin/index.php?action=logout" 
                class="dropdown-item">
